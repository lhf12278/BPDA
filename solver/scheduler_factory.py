...
"""
from .cosine_lr import CosineLRScheduler,WarmupMultiStepLR


def create_scheduler(cfg, optimizer,class_optimizer,class2_optimizer):
    ...
    return lr_scheduler,class_lr_scheduler,class2_lr_scheduler
